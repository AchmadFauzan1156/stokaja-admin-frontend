      ...
      <div className="px-4 pt-14">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-squadaOne text-[30px] leading-tight text-[#6E822E]">Metode<br/>Pembayaran</h1>
          </div>
          <button
          ...
          <div className="flex flex-col gap-3">
            {payments.map((pay) => (
              <div key={pay._id} className="flex flex-col rounded-[20px] border-2 border-[#D6D6D6] bg-[#F5F5F5] p-4">
                <div className="flex items-center justify-between">
                  <h2 className="font-squadaOne text-[24px] text-[#4B4B4B] capitalize">{pay.nama}</h2>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-3xl bg-white p-6">
            <h2 className="mb-4 font-squadaOne text-[28px] text-[#6E822E]">{editingId ? "Edit" : "Tambah"} Metode</h2>
